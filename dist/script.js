...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_cnangeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
...
/***/ "./src/js/modules/cnangeModalState.js":
/*!********************************************!*\
  !*** ./src/js/modules/cnangeModalState.js ***!
  \********************************************/
/*! exports provided: default */
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (evt) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        Object(_modals__WEBPACK_IMPORTED_MODULE_6__["closeModal"])(popupCalcEnd); // clear value in object state (reset request)
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateTime() {
      var time = getTImeRemaining(endtime); // How much time is left
...
var validation = function validation() {
  var nameInput = document.querySelectorAll('input[name="user_name"]'),
      numberInput = document.querySelectorAll('input[name="user_phone"]');
  var MAX_NAMELENGTH = 10;
  var MIN_NAMELENGTH = 2;
  nameInput.forEach(function (elem) {
    elem.addEventListener('input', function () {
      var inputNameText = elem.value;
